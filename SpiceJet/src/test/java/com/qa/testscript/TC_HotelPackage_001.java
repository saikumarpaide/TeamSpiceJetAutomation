...
public class TC_HotelPackage_001 extends TestBase {
	HotelPackage hotel;

	@Test
	public void HotelPackageForm(Method method) throws IOException {
		exTest = ExtentTestManager.startTest(method.getName(), "HotelPackageForm");
